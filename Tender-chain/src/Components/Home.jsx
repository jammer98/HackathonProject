...
function Home() {
    ...
    return (
        <div className='h-screen w-full bg-neutral-900'>
            {/* Navbar */}
            <nav className='bg-neutral-900 flex justify-between items-center py-4 fixed top-0 left-0 w-full z-10 px-8'>
            ...
            {/* Hero Section */}
            <div className='flex flex-col justify-center items-center w-full h-full pt-20 gap-20'>
                <div className='bg-neutral-900 text-neutral-900 py-30 px-4 w-full '>
                    <h1>badbadbdbdubdwudvWUBCUWBCUWBCUAWCBWCHBWUCB<br/>r</h1>
                </div>
                    <div className='bg-green-400 w-full flex flex-col justify-center items-center py-25 px-4'>
                    <div className='text-center'>
                        ...
                        <p className='text-black text-xl font-["Montserrat"] tracking-normal font-semibold'>Blockchain-powered decentralized tender system ensuring fair allocation,<br /> transparent processes, and complete accountability in government procurement.</p>
                    </div>
                </div>
                <div className='w-full flex justify-center items-center py-30 bg-neutral-900'>
                    <button onClick={ () => window.open("https://sepolia.etherscan.io/address/0x0cf5ffb83022f9c5a2b7417fea77e6c1009d79e6#code", "_blank") } class="inline-flex items-center gap-2 bg-neutral-700 hover:bg-neutral-600 px-4 py-2 rounded-full cursor-pointer">
